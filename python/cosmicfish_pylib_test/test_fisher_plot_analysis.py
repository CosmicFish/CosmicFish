...
class test_plot_range():
    ...
    def test_compute_plot_range_nice(self):
        assert self.fisher_list_test.compute_plot_range() == {'pa0': [-1.0, 1.0], 'pa1': [-0.8, 1.8], 'pa2': [-0.6000000000000001, 2.6], 'pa3': [0.5, 2.5], 'pa4': [1.5, 2.5]}
    ...
    def test_compute_plot_range_parameters(self):
        ...
        assert self.fisher_list_test.compute_plot_range(['pa1','pa2']) == {'pa1': [-0.8, 1.8], 'pa2': [-0.6000000000000001, 2.6]}
...
class test_compute_gaussian():
    ...
    def test_compute_gaussian_all(self):
        ...
        assert list(list(results_1.values())[0].keys()) == ['fisher1', 'fisher2', 'fisher3']
    ...
    def test_compute_gaussian_one_fisher(self):
        ...
        assert list(list(results_1.values())[0].keys()) == ['fisher1']
...
class test_compute_compute_ellipse():
    ...
    def test_compute_ellipse_all(self):
        ...
        assert list(results_1.keys()) == ['pa0', 'pa1', 'pa2', 'pa3', 'pa4']
        assert list(list(results_1.values())[0].keys()) == ['pa0', 'pa1', 'pa2', 'pa3', 'pa4']
        assert list(list(list(results_1.values())[0].values())[0].keys()) == ['fisher1', 'fisher2', 'fisher3']
    ...
    def test_compute_ellipse_one_param_one_param(self):
        ...
        assert list(results_1.keys()) == ['pa1']
        assert list(list(results_1.values())[0].keys()) == ['pa2']
        assert list(list(list(results_1.values())[0].values())[0].keys()) == ['fisher1', 'fisher2', 'fisher3']
    ...
    def test_compute_ellipse_one_fisher(self):
        ...
        assert list(results_1.keys()) == ['pa0', 'pa1', 'pa2']
        assert list(list(results_1.values())[0].keys()) == ['pa0', 'pa1', 'pa2']
        assert list(list(list(results_1.values())[0].values())[0].keys()) == ['fisher1']
