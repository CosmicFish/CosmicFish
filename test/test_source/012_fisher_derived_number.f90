...
program test_fisher_derived_number
    ...
    write(100,*) 'Want derived: ', FP%cosmicfish_want_derived
    write(100,*) 'Number of parameters of the Fisher matrix: ', num_param
    write(100,*) 'Number of derived parameters             : ', num_derived
...
end program test_fisher_derived_number
