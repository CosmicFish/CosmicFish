...
program test_fisher_derived_paramnames
    ...
    call save_derived_paramnames_to_file( P, FP, num_param, num_derived, filename="output")
    ! all the successful test should return the following.
    stop 100

end program test_fisher_derived_paramnames
