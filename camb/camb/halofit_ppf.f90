    ...
    do itf = 1, CAMB_Pk%num_z
        ...
        om_m = omega_m(a, omm0, CP%omegav, CP%w_lam, CP%wa_ppf)
        om_v = omega_v(a, omm0, CP%omegav, CP%w_lam, CP%wa_ppf)
        acur = a
        xlogr1=-2.0
        xlogr2=3.5
        do
...
101     continue
    ...
    elseif (halofit_version == halofit_takahashi) then
        ...
        a=1.5222+2.8553*rn+2.3706*rn*rn+0.9903*rn*rn*rn+ &
            0.2250*rn*rn*rn*rn-0.6038*rncur+0.1749*om_v*(1.+CP%w_lam+CP%wa_ppf*(1-acur))
        a=10**a
        b=10**(-0.5642+0.5864*rn+0.5716*rn*rn-1.5474*rncur+ &
            0.2279*om_v*(1.+CP%w_lam+CP%wa_ppf*(1-acur)))
